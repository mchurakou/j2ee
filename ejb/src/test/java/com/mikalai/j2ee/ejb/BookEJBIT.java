...
public class BookEJBIT {
    ...
    public void shouldCreateABook() throws Exception {
        ...
        try (EJBContainer ec = EJBContainer.createEJBContainer(properties)) {
            ...
            assertNotNull(ctx.lookup("java:global/classes/BookEJB!com.mikalai.j2ee.ejb.BookEJBRemote"));
            assertNotNull(ctx.lookup("java:global/classes/BookEJB!com.mikalai.j2ee.ejb.BookEJB"));

            // Looks up the EJB
            BookEJB bookEJB = (BookEJB) ctx.lookup("java:global/classes/BookEJB!com.mikalai.j2ee.ejb.BookEJB");
